...
public class Trimester2 extends AppCompatActivity {

    CheckBox CheckG26, CheckG29, CheckG30, CheckG31, CheckG32, CheckG33, CheckG34, CheckG35,
            CheckG36, CheckG37, CheckG38, CheckG39, CheckG40, CheckG41, CheckG42, CheckG43,
            CheckG44, CheckG45, CheckG46, CheckG47, CheckG48, CheckG49, CheckG08, CheckG50,
            CheckG51, CheckG52, CheckG53, CheckG54, CheckG55, CheckG56, CheckG57, CheckG63,
            CheckG64, CheckG65, CheckG66, CheckG67, CheckG68, CheckG69;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_trimester2);
        ...
        CheckG37 = (CheckBox)findViewById(R.id.G37);
        CheckG38 = (CheckBox)findViewById(R.id.G38);
        CheckG39 = (CheckBox)findViewById(R.id.G39);
        CheckG40 = (CheckBox)findViewById(R.id.G40);
        CheckG41 = (CheckBox)findViewById(R.id.G41);
        CheckG42 = (CheckBox)findViewById(R.id.G42);
        CheckG43 = (CheckBox)findViewById(R.id.G43);
        ...
        btn_deteksi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Jenis Gejala untuk Penyakit : Kehamilan Ektopik Terganggu
                if(CheckG32.isChecked() && CheckG36.isChecked() && CheckG37.isChecked() && CheckG38.isChecked()
                        && CheckG39.isChecked() && CheckG40.isChecked()){
                    NamaPenyakit += "\nKehamilan Ektopik Terganggu";
                }
                //Jenis Gejala untuk Penyakit : Mola Hidatidosa
                if(CheckG41.isChecked() && CheckG32.isChecked() && CheckG42.isChecked() && CheckG43.isChecked()){
                    NamaPenyakit += "\nMola Hidatidosa";
                }
                ...
                Intent i = new Intent(Trimester2.this, Identifikasi.class);
