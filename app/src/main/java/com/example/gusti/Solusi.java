...
import com.example.gusti.solusi.Solusi_Abortus_Iminens;
import com.example.gusti.solusi.Solusi_Abortus_Inkompletus;
import com.example.gusti.solusi.Solusi_Abortus_Insipiens;
import com.example.gusti.solusi.Solusi_Abortus_Kompletus;
import com.example.gusti.solusi.Solusi_Anemia;
import com.example.gusti.solusi.Solusi_Emesis_Gravidarum;
import com.example.gusti.solusi.Solusi_Hiperemesis_Gravidarum_Tipe1;
import com.example.gusti.solusi.Solusi_Hiperemesis_Gravidarum_Tipe2;
import com.example.gusti.solusi.Solusi_Hiperemesis_Gravidarum_Tipe3;
import com.example.gusti.solusi.Solusi_Hipertensi_Gestasional;
import com.example.gusti.solusi.Solusi_Infeksi_Saluran_Kemih;
import com.example.gusti.solusi.Solusi_Kehamilan_Ektopik_Terganggu;
import com.example.gusti.solusi.Solusi_Mola_Hidatidosa;
import com.example.gusti.solusi.Solusi_Plasenta_Previa;
import com.example.gusti.solusi.Solusi_Plasenta_Previa_Letak_Rendah;
import com.example.gusti.solusi.Solusi_Plasenta_Previa_Leteralis;
import com.example.gusti.solusi.Solusi_Plasenta_Previa_Marginal;
import com.example.gusti.solusi.Solusi_Plasenta_Previa_Totalis;
import com.example.gusti.solusi.Solusi_Preeklamsia;
import com.example.gusti.solusi.Solusi_Solusio_Plasenta_Berat;
import com.example.gusti.solusi.Solusi_Solusio_Plasenta_Ringan;
import com.example.gusti.solusi.Solusi_Solusio_Plasenta_Sedang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_EmesisGravidarum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Emesis_Gravidarum.class);
        ...
        btn_HiperemesisGravidarumTipeI.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Hiperemesis_Gravidarum_Tipe1.class);
                startActivity(intent);
            }
        });
        ...
        btn_HiperemesisGravidarumTipeII.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Hiperemesis_Gravidarum_Tipe2.class);
                startActivity(intent);
            }
        });
        ...
        btn_HiperemesisGravidarumTipeIII.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Hiperemesis_Gravidarum_Tipe3.class);
                startActivity(intent);
            }
        });
        ...
        btn_Preeklamsia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Preeklamsia.class);
                startActivity(intent);
            }
        });
        ...
        btn_HipertensiGestasional.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Hipertensi_Gestasional.class);
                startActivity(intent);
            }
        });
        ...
        btn_AbortusIminens.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Abortus_Iminens.class);
                startActivity(intent);
            }
        });
        ...
        btn_AbortusInsipiens.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Abortus_Insipiens.class);
                startActivity(intent);
            }
        });
        ...
        btn_AbortusInkompletus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Abortus_Inkompletus.class);
                startActivity(intent);
            }
        });
        ...
        btn_AbortusKompletus.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Abortus_Kompletus.class);
                startActivity(intent);
            }
        });
        ...
        btn_KehamilanEktopikTerganggu.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Kehamilan_Ektopik_Terganggu.class);
                startActivity(intent);
            }
        });
        ...
        btn_MolaHidatidosa.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Mola_Hidatidosa.class);
                startActivity(intent);
            }
        });
        ...
        btn_SolusioPlasentaBerat.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Solusio_Plasenta_Berat.class);
                startActivity(intent);
            }
        });
        ...
        btn_SolusioPlasentaSedang.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Solusio_Plasenta_Sedang.class);
                startActivity(intent);
            }
        });
        ...
        btn_SolusioPlasentaRingan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Solusio_Plasenta_Ringan.class);
                startActivity(intent);
            }
        });
        ...
        btn_PlasentaPrevia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Plasenta_Previa.class);
                startActivity(intent);
            }
        });
        ...
        btn_PlasentaPreviaTotalis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Plasenta_Previa_Totalis.class);
                startActivity(intent);
            }
        });
        ...
        btn_PlasentaPreviaLateralis.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Plasenta_Previa_Leteralis.class);
                startActivity(intent);
            }
        });
        ...
        btn_PlasentaPreviaMarginal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Plasenta_Previa_Marginal.class);
                startActivity(intent);
            }
        });
        ...
        btn_PlasentaPreviaLetakRendah.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Plasenta_Previa_Letak_Rendah.class);
                startActivity(intent);
            }
        });
        ...
        btn_Anemia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Anemia.class);
                startActivity(intent);
            }
        });
        ...
        btn_InfeksiSaluranKemihPadaKehamilan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), Solusi_Infeksi_Saluran_Kemih.class);
                startActivity(intent);
            }
        });
        ...
        ib_home.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Solusi.this.startActivity(new Intent(Solusi.this, Halaman_Utama.class));
            }
        });
    }
}